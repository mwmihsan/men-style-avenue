      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in">
            <h3 className="text-3xl font-montserrat font-semibold text-white mb-4">
              Our Story
            </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
              <Card className="bg-brand-gray border-brand-gold/20 card-hover">
                <CardContent className="p-6 text-center">
                  <div className="text-3xl font-bold text-gradient mb-2 font-montserrat">5+</div>
                  <p className="text-sm text-gray-300 font-poppins">Years Experience</p>
                </CardContent>
              </Card>
              <Card className="bg-brand-gray border-brand-gold/20 card-hover">
                <CardContent className="p-6 text-center">
                  <div className="text-3xl font-bold text-gradient mb-2 font-montserrat">1000+</div>
                  <p className="text-sm text-gray-300 font-poppins">Happy Customers</p>
                </CardContent>
              </Card>
              <Card className="bg-brand-gray border-brand-gold/20 card-hover">
                <CardContent className="p-6 text-center">
                  <div className="text-3xl font-bold text-gradient mb-2 font-montserrat">🌍</div>
                  <p className="text-sm text-gray-300 font-poppins">Worldwide Delivery</p>
                </CardContent>
              </Card>
            </div>
          </div>
